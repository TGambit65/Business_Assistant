...
const InboxPage = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-[calc(100vh-4rem)] bg-gray-50 dark:bg-gray-900">
      {/* Mobile sidebar toggle */}
      <div className="md:hidden sticky top-0 z-10 bg-white dark:bg-gray-800 p-3 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
      ...
      {/* Email categories sidebar - Mobile overlay */}
      <aside className={`fixed md:relative inset-0 bg-white dark:bg-gray-800 p-4 border-r border-gray-200 dark:border-gray-700 z-20 transition-all duration-300 transform ${
        sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'
      } md:w-64 md:static`}>
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-white">Mail</h2>
          <button 
        ...
        {/* Unified navigation list with drag and drop */}
                      ...
                      >
                        <div className="flex items-center">
                          <div 
                            ...
                            className="p-1 mr-1 cursor-move text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"
                          >
                          ...
                          >
                            <div className="flex items-center">
                              {item.isLabel ? (
                                <div className={`h-3 w-3 rounded-full ${item.backgroundColor} mr-3 flex-shrink-0`}></div>
                              ) : (
      ...
      <div className="flex-1 flex flex-col">
        {/* Toolbar */}
        <div className="bg-white dark:bg-gray-800 p-2 sm:p-4 border-b border-gray-200 dark:border-gray-700 flex flex-wrap gap-2">
          ...
          <div className="relative flex-1 max-w-md ml-auto">
            ...
            <input
              ...
              className="pl-10 w-full rounded-md border border-gray-300 dark:border-gray-600 py-1.5 sm:py-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-primary focus:border-primary"
            />
          </div>
        </div>
          ...
          <div className="p-3 sm:p-4 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              <div>
                ...
                <select className="w-full rounded-md border border-gray-300 dark:border-gray-600 py-1.5 sm:py-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
            ...
            <div className="mt-4 flex justify-end space-x-2">
              <button className="px-3 py-1.5 sm:px-4 sm:py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-600">
                Reset
              </button>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center px-4 py-3">
                    ...
                    <div className="flex-1 min-w-0 sm:ml-3">
                      <div className="sm:flex sm:items-center sm:justify-between">
                        <p className="font-medium text-sm sm:text-base truncate text-gray-900 dark:text-white">
